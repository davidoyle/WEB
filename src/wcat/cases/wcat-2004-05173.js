const caseData = {
  ...
  description:
    'Worker injured during an employer-required FCE for a promotion; WCAT held it occurred in the course of employment and was compensable.',
  strategyMoves: [
  ...
  portableStrategy:
    'Always frame tests or assessments required for employment or promotion as work tasks, not medical treatment.',
  category: 'Is my injury covered? – Acceptability & causation',
  shortLabel: 'Injury during Functional Capacity Evaluation (FCE)',
  fullLabel: 'Injury during Functional Capacity Evaluation (FCE)',
  keyPoints: [
    'Attendance at an employer-required FCE was part of employment, making the injury compensable.',
    'Work-related testing that is required for advancement attracts coverage even when done off-site.',
  ],
