const caseData = {
  ...
  "category": "Challenging Board medical advisors & internal practice",
  "shortLabel": "Limits on Board Medical Advisors & internal guidelines",
  "fullLabel": "Limits on Board Medical Advisors & internal guidelines",
  "keyPoints": [
    "Board medical advisors provide medical input, not policy interpretation.",
    "Internal guidelines cannot override binding Board policy when weighing opinions."
  ],
