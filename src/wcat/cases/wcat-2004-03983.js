const caseData = {
  ...
  "shortLabel": "Second decision after 75 days is reviewable",
  "fullLabel": "Second decision after 75 days is reviewable",
  "keyPoints": [
    "A second decision issued after 75 days is a fresh, reviewable decision.",
    "Late corrections can be appealed as new decisions."
  ],
  "facts": [
    "If the Board issues a second decision more than 75 days after the first to correct an error, that second decision is reviewable."
  ],
  "howToUse": [
    "Treat late 'fix' decisions as new, reviewable decisions",
    "Argue Board policy gaps don’t shield untimely corrections"
