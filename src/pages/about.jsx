  ...
  <div className="min-h-screen bg-gray-50">
    ...
    <main className="section-shell py-10 space-y-8">
      ...
      <section className="card space-y-3">
        ...
        <p className="text-gray-700">
          Worker&apos;s Toolkit was started in 2025 by an injured worker in British Columbia and is
          being built with a small team of workers and allies. Direction comes from workers and
          advisors who have been through the system and want better tools to push back.
        </p>
      </section>
      ...
      <section className="card space-y-3">
        ...
        <p className="text-gray-700">
          This is a grassroots project in its early stages. It is not funded by WorkSafeBC,
