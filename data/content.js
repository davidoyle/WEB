export const screwedSituations = [
  {
    ...
    gentleDescription:
      'You are early in. You might still be getting paid. Things feel confusing but not openly hostile yet.',
    indicators: [
...
export const pressurePoints = [
  {
    ...
    whyItMatters:
      'Delays are predictable harm. Every day stalled = evidence of systemic negligence.',
  },
  {
    id: 'evidence-ignored',
    ...
    icon: '⚖️',
    summary:
      "Anytime WorkSafeBC leans on a board doctor you've never met, declares your injury 'resolved' while your providers say otherwise, or refuses to explain why one piece of evidence beat another.",
    examples: [
  ...
  },
  {
    ...
    icon: '📁',
    summary:
      "You hear lines like: 'Our records show you haven't contacted us' or 'There is no record of that email/call,' while you have screenshots, emails, and call logs.",
    examples: [
...
export const documentationPowerPoints = [
  {
    ...
    description:
      'Your injury and claim will stretch over months or years. Memories blur; staff change. Written records let you go back and prove what happened when.',
  },
  {
    title: 'It Turns Feelings into Facts',
    description:
      '"They don\'t believe me" turns into: "On March 12, I sent Dr. Singh\'s note restricting lifting to 10 lbs. On April 2, the case manager approved heavy-duty work without addressing that note."',
  },
  {
    title: 'It Makes Appeals Winnable',
    description:
      "Review Division and WCAT aren't about who sounds more upset. They're about evidence, timelines, and policy. Documents are your ammo.",
  },
];
...
export const speakingImpactFlow = [
  ...
  },
  {
    title: 'Oversight',
    description:
      "Patterns trigger attention from MLAs, tribunals, and media because they can't be dismissed as one-off.",
  },
  {
    title: 'Policy Change',
...
export const socialProofConfig = {
  ...
  current: 2,
  quote:
    'Sometimes the truth takes time to be exposed... but sometimes the truth is right in front of us.',
};
...
export const engagementPoints = [
  {
    ...
    description:
      "It's not about being loud; it's about being precise. Every email is a potential exhibit later. Every unanswered question becomes: 'they ignored a relevant factor.'",
  },
  {
    title: "When You Don't Engage",
    description:
      "Silence feels safer in the moment. But it leaves a blank record. When you challenge a decision, there's nothing to point to except their version of events.",
  },
  {
    title: 'What Engagement Looks Like',
    description:
      "Written questions. Documented calls. Timelines. Choosing when to escalate to Review/WCAT/MLA. You're building a case, not begging.",
  },
];
