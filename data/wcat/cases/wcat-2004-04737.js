const caseData = {
  ...
  description:
    'Teacher assaulted by a student developed acute stress; WCAT compensated the psychological injury under s.5(1) as consequential to the physical injury.',
  strategyMoves: [
  ...
  portableStrategy:
    'When mental health issues flow from a physical injury, argue them under s.5(1) as consequential injuries for broader coverage.',
  category: 'Is my injury covered? – Acceptability & causation',
  shortLabel: 'Teacher assaulted; physical + mental injury',
  fullLabel: 'Teacher assaulted; physical + mental injury',
  keyPoints: [
    'Consequential psychological injuries flowing from a physical assault were accepted under s.5(1).',
    'WCAT preferred a mixed physical/psych framing over the narrower mental-disorder route.',
  ],
